...
if(isset($_POST['submit'])):
    ...
    $query ="SELECT * FROM `item_inventory` WHERE CONCAT(`SerialID`,`item_image`, `item_model`, `item_brand`,
					...
					<div class="modal-footer">					
                        ...
                        <?php 
                            if(isset($_POST['accept'])){
                                ...
                                `item_description`, `Type`, `item_category`, `item_quantity`, `item_status`) 
                                VALUES ('$serialNum','$item_image','$item_model','$item_brand','$item_desc','$item_type','$item_category','$item_quantity','$item_status')";
